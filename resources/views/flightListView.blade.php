...
<div class="container flightcontainer">
    <div class="row flightlistrow">
        <div class="col-md-12 col-sm-12 flightlist">
            ...
            <div class="col-md-4 col-sm-4 weather"><img src="../images/thermometer.ico" class="weathericon" width="20px" height="20px"> {{round($weather[$flight->getDestination()->getLocation()] -> getTemperature(),1)}} °C
            </div>
